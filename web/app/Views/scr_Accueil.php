...
<main>
  ...
  <section class="my-3 py-5 text-center container bg-accueil">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light text-white">Food Seeker</h1>
        <p class="lead text-white">Partagez et trouvez vos idées de recettes sur Food Seeker.</p>
        <p>
